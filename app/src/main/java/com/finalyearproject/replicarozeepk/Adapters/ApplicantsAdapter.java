...
public class ApplicantsAdapter extends  Adapter<ApplicantsAdapter.ViewHolder>{

    public Context context;
    public List<UserData> data;
    public ApplicantsAdapter(Context context, List<UserData> data){
    ...
    @NotNull
    @Override
    public ApplicantsAdapter.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull ApplicantsAdapter.ViewHolder holder, int position) {

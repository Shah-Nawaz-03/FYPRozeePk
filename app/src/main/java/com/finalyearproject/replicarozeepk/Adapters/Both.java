...
public class Both extends RecyclerView.Adapter<Both.ViewHolder> {

    public Context context;
    public List<UserData> data;
    public Both(Context context, List<UserData> data){
    ...
    @NotNull
    @Override
    public Both.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
